...
public class CrazyClient {
	...
	private CrazyClientController controller;
	 ...
	 * @throws IOException
	 */
	public CrazyClient(int port) throws IOException
	{
		this.port = port;
		...
		this.controller = new CrazyClientController(size, values, this, index);
